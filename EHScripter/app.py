...
class EHScripterApplication(Frame):
    ...
    def readOutput(self):
        ...
        self.inputs['doc']['filter']=self.widgets['doc']['filter'].get()
    ...
    def setupDocPropFrame(self):
        self.frameDocProp = Frame(self.notebook, padding="10 10 10 10")

        Label(self.frameDocProp, text="Pie:").grid(column=1, row=1, sticky=(E))
        Label(self.frameDocProp, text="Figure:").grid(column=1, row=2, sticky=(E))
        Label(self.frameDocProp, text="Table:").grid(column=1, row=3, sticky=(E))
        Label(self.frameDocProp, text="Category:").grid(column=1, row=4, sticky=(E))
        Label(self.frameDocProp, text="Matrix:").grid(column=1, row=5, sticky=(E))
        Label(self.frameDocProp, text="Summarized Matrix:").grid(column=1, row=6, sticky=(E))
        Label(self.frameDocProp, text="Risk Header:").grid(column=1, row=7, sticky=(E))
        Label(self.frameDocProp, text="SUM Header:").grid(column=1, row=8, sticky=(E))
        Label(self.frameDocProp, text="Critical long:").grid(column=1, row=9, sticky=(E))
        Label(self.frameDocProp, text="High long:").grid(column=1, row=10, sticky=(E))
        Label(self.frameDocProp, text="Medium long:").grid(column=1, row=11, sticky=(E))
        Label(self.frameDocProp, text="Low long:").grid(column=1, row=12, sticky=(E))
        Label(self.frameDocProp, text="Info long:").grid(column=1, row=13, sticky=(E))

        Label(self.frameDocProp, text="Critical short:").grid(column=3, row=9, sticky=(E))
        Label(self.frameDocProp, text="High short:").grid(column=3, row=10, sticky=(E))
        Label(self.frameDocProp, text="Medium short:").grid(column=3, row=11, sticky=(E))
        Label(self.frameDocProp, text="Low short:").grid(column=3, row=12, sticky=(E))
        Label(self.frameDocProp, text="Info short:").grid(column=3, row=13, sticky=(E))
        Label(self.frameDocProp, text="Risk list:").grid(column=1, row=14, sticky=(E))
        Label(self.frameDocProp, text="Category list:").grid(column=1, row=15, sticky=(E))

        Label(self.frameDocProp, text="REGEX Title:").grid(column=3, row=1, sticky=(E))
        Label(self.frameDocProp, text="REGEX Category:").grid(column=3, row=2, sticky=(E))
        Label(self.frameDocProp, text="REGEX Risk level:").grid(column=3, row=3, sticky=(E))
        Label(self.frameDocProp, text="REGEX Assessment state:").grid(column=3, row=4, sticky=(E))
        Label(self.frameDocProp, text="REGEX Related risk:").grid(column=3, row=5, sticky=(E))
        Label(self.frameDocProp, text="REGEX Recommendation:").grid(column=3, row=6, sticky=(E))



        self.addEntry(self.frameDocProp, 'doc', 'txt_pie', 2, 1)
        self.addEntry(self.frameDocProp, 'doc', 'txt_figure', 2, 2)
        self.addEntry(self.frameDocProp, 'doc', 'txt_table', 2, 3)
        self.addEntry(self.frameDocProp, 'doc', 'txt_category', 2, 4)
        self.addEntry(self.frameDocProp, 'doc', 'txt_matrix', 2, 5)
        self.addEntry(self.frameDocProp, 'doc', 'txt_summarized_matrix', 2, 6)
        self.addEntry(self.frameDocProp, 'doc', 'txt_summarized_matrix_risks', 2, 7)
        self.addEntry(self.frameDocProp, 'doc', 'txt_summarized_matrix_sum', 2, 8)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_critical', 2, 9)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_high', 2, 10)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_medium', 2, 11)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_low', 2, 12)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_info', 2, 13)

        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_short_critical', 4, 9)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_short_high', 4, 10)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_short_medium', 4, 11)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_short_low', 4, 12)
        self.addEntry(self.frameDocProp, 'doc', 'txt_risk_short_info', 4, 13)
        self.addEntry(self.frameDocProp, 'doc', 'list_risks', 2, 14)
        self.addEntry(self.frameDocProp, 'doc', 'list_categories', 2, 15)

        self.addEntry(self.frameDocProp, 'doc', 'regex_title', 4, 1)
        self.addEntry(self.frameDocProp, 'doc', 'regex_category', 4, 2)
        self.addEntry(self.frameDocProp, 'doc', 'regex_risk_level', 4, 3)
        self.addEntry(self.frameDocProp, 'doc', 'regex_assessment_state', 4, 4)
        self.addEntry(self.frameDocProp, 'doc', 'regex_related_risk', 4, 5)
        self.addEntry(self.frameDocProp, 'doc', 'regex_recommendation', 4, 6)

        self.frameDocProp.columnconfigure(1, weight=3, minsize=120)
        self.frameDocProp.columnconfigure(2, weight=3, minsize=120)
        self.frameDocProp.columnconfigure(3, weight=3, minsize=120)
        self.frameDocProp.columnconfigure(4, weight=3, minsize=120)

        self.frameDocProp.rowconfigure(1, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(2, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(3, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(4, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(5, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(6, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(7, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(8, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(9, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(10, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(11, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(12, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(13, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(14, weight=3, minsize=30)
        self.frameDocProp.rowconfigure(15, weight=3, minsize=30)
    ...
    def setupDocFrame(self):
        ...
        Label(self.frameDoc, text="Filter (comma separated wordlist):").grid(column=1, row=10, sticky=(E))
        ...
        self.addEntry(self.frameDoc, 'doc', 'filter', 2, 10)

        Button(self.frameDoc, text="RUN", command=self.docRun).grid(column=1, row=11, columnspan=4)
    ...
    def setupGUI(self):
        ...
        self.notebook.add(self.frameDocProp, text='DOC Properties')
